...
#SBATCH --time=3-23:58      # time (DD-HH:MM)
#SBATCH --output=slurm_outputs/dcgan-accuracy-%u-%x-%j.txt
#SBATCH --mail-user=xz2yu@uwaterloo.ca
#SBATCH --mail-type=ALL
project_dir=~/projects/def-karray/xz2yu/thesis/data/
version=data-aug-accuracy-$(date +%d_%m_%Y_%H_%M)
...
python -u accuracy.py --dataset_dir $SLURM_TMPDIR --output_dir $version_path --generated_dir $generated_path --dataset $dataset --comparison $comparison
