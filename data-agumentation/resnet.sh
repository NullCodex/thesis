...
#SBATCH --output=slurm_outputs/resnet-%u-%x-%j.txt
#SBATCH --mail-user=xz2yu@uwaterloo.ca
#SBATCH --mail-type=ALL
dataset=$VAR1
project_dir=~/projects/def-karray/xz2yu/thesis/data/
version=data-aug-resnet-$dataset-$(date +%s%3N_%d_%m_%Y_%H_%M)
...
python resnet.py --dataset_dir $SLURM_TMPDIR --output_dir $version_path --dataset $dataset
